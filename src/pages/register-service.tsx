...
import { addContactGroups, registerServiceFormSchema } from "@/components/form_schemas/register-service-form";
...
export default function RegisterServicePage()
{
    ...
    const formSchema = registerServiceFormSchema(contactGroupOptions);
    ...
    const endpoint = import.meta.env.VITE_REGISTER_SERVICE_ENDPOINT
